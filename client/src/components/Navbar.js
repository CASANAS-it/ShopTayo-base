    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">ShopTayo</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/buyers">
            <ListItem button key="Buyer">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Buyer" />
            </ListItem>
          </Link>{" "}            
           <Link to="/products">
           ...
           <Link to="/transactions">
            <ListItem button key="Transaction">
              ...
              <ListItemText className="menu-text" primary="Transaction" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
